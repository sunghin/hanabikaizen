  ...
  return (
    <section className="flex min-h-[calc(100vh-7.5rem)] flex-col justify-between rounded-[2rem] border border-[color:var(--border)] bg-black px-6 py-8 sm:px-10 sm:py-10 lg:px-12 lg:py-12">
      <div className="max-w-[720px] space-y-8">
        ...
        <h1 className="max-w-[980px] text-5xl leading-[0.95] font-medium tracking-[-0.04em] text-white sm:text-7xl lg:text-[6.5rem]">
          {content.headline}
        </h1>
      </div>
      ...
      <div className="mt-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
        <a
          ...
          className="w-fit rounded-full border border-[color:var(--border)] bg-white px-5 py-3 text-sm font-medium text-black transition hover:bg-white/90"
        >
